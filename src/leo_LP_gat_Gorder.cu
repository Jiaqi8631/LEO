...
int main(int argc, char* argv[]){
    ...
    nidType numMyNodes = e_ub - e_lb;
    nidType numMyEdges = global_row_ptr[e_ub] - global_row_ptr[e_lb]; //already checked
    ...
    for (int i = 0; i < num_profiles; i++)
    {
        ...
        leo_GAT_LP(dp1->d_atten, dp1->part_feat, dp1->d_out, dp1->edge_atten, dp1->edge_tmp, id_map, d_row_ptr, 
                d_col_ind, mype_node, numNodes, partSize, warpPerBlock, hiddenSize, num_id_map); //dense --> dense_out
        ...
        leo_GAT_DP(dp2->d_atten, dp1->d_in, dp2->d_out, dp2->edge_atten, dp2->edge_tmp, id_map, d_row_ptr,
               d_col_ind, lower_bound, mype_node, numNodes, partSize, warpPerBlock, outdim, range_id_map);
    }
