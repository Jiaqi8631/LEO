...
int main(int argc, char* argv[]){
    ...
    //const char *reorder_file = argv[12];
    ...
    //std::string dset = "dataset/preprocess/reddit.dgl.new_reorder_thres_0.2";
    std::string dset = reorder_file;
    auto reorder_out = load_reorder_graph<nidType>(dset, numNodes, numEdges, global_row_ptr, global_col_ind);
